...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        String projectPath = System.getProperty("user.dir");  //jdk会 找到当前项目所在的路径
        ...
        strategy.setNaming(NamingStrategy.underline_to_camel);//数据库表映射到实体的命名策略    下划线 改成驼峰
        strategy.setTablePrefix(moduleName + "_");//设置表前缀不生成    表前缀edu
